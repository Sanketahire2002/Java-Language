...
public class ICICIBank implements BanksInterface
{
	...
	public void deposit(double amount) throws InvalidAmountException,NumberFormatException
	{
		if(amount < 0)
		{
			throw new InvalidAmountException("ICICI. Amount cannot be negative. Please Enter amount greater than 0.");
		}
		else
		{
	...
	public double withdraw(double amount) throws InvalidAmountException,InsufficientFundException,NumberFormatException
	{
		...
		{
			throw new InsufficientFundException("ICICI. Available balance in account is less than requsted withdrawal Amount. Please Enter withdrawal valid amount.");
		}
	...
	{
		System.out.println("ICICI. Available Balance = "+this.balance);
	}
}